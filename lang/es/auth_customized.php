...
$string['emailpasswordconfirmmaybesent'] = '<p>Si ha suministrado información correcta, se le debería haber enviado un correo electrónico.</p>
...
$string['forgotpasswordbyemail'] = 'Recuperar por correo electrónico';
$string['forgotpasswordbyemail_help'] = 'Si se habilita, el usuario podrá recuperar su contraseña introduciendo su dirección de correo electrónico.';
$string['forgotpasswordbyusername'] = 'Recuperar por nombre de usuario';
$string['forgotpasswordbyusername_help'] = 'Si se habilita, el usuario podrá recuperar su contraseña introduciendo su nombre de usuario.
Está deshabilitado si se usa la dirección de correo electrónico como nombre de usuario.';
...
$string['settingsheaderforgotpassword'] = 'Opciones de recuperación de contraseña';
